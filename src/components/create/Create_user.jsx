             ...
             <div className='col-lg-8  pt-3 store_register_right'>
              ...
              <div className='register_new_container'>
                        <div className='store_register_box  shadow p-3 mb-5 bg-body rounded'>
                               <h6 className='fw-bold text-center'> Create New User</h6>
                    ...
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Password<span class="text-danger"> *</span></label> <input type="text" id="fname" name="fname" placeholder="Password" onblur="validate(1)" /> </div>
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Confirm Password<span class="text-danger"> *</span></label> <input type="text" id="lname" name="lname" placeholder="Confirm Password" onblur="validate(2)" /> </div>
                    ...
                    <div class="row justify-content-end m-3 ml-n3">
                        <div class="form-group col-sm-6"> <button type="submit" class="btn-block ">User Register</button> </div>
                    </div>
                </form>
